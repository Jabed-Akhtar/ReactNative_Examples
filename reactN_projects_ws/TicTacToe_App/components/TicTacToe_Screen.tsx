...
/* TicTacToe-Screen ========================================================= */
export default function TicTacToe_Screen() {
  ...
  /*--------------- Fun - on change item / on clicking on box ---------------*/
  const onChangeItem = (itemNumber: number) => {
    ...
    if (gameState[itemNumber]==='empty'){
      ...
      return Snackbar.show({
        text: "Position is alright filled",
        backgroundColor: "red",
        textColor: "#FFFFFF"
      })
    }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTxt}>TicTacToe Game</Text>
      </View>
      {gameWinner ? (
